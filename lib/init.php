...
$bdd = new PDO("mysql:host=172.18.0.1;dbname=financement-omar;charset=UTF8", "financement-omar", "T?59jpyytk");
...
require_once __DIR__ . "/../modele/message.php";
require_once __DIR__ . "/../modele/archive.php";
